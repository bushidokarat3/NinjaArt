...
class Ui_MainWindow(object):
    ...
    def setupMainTabs(self):
        ...
        # NXC Tab (NetExec / CrackMapExec)
        self.NxcTab = QWidget()
        self.NxcTab.setObjectName(_fromUtf8("NxcTab"))
        self.horizontalLayout_8 = QHBoxLayout(self.NxcTab)
        self.horizontalLayout_8.setObjectName(_fromUtf8("horizontalLayout_8"))
        self.NxcTabWidget = QTabWidget(self.NxcTab)
        self.NxcTabWidget.setObjectName(_fromUtf8("NxcTabWidget"))
        self.horizontalLayout_8.addWidget(self.NxcTabWidget)
        self.MainTabWidget.addTab(self.NxcTab, _fromUtf8(""))
...
#       self.BottomTabWidget.addTab(self.PythonTab, _fromUtf8(""))      
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QApplication.translate("MainWindow", "NinjaArt 1.0", None))
...
#       self.ServicesTabWidget.setTabText(self.ServicesTabWidget.indexOf(self.ScreenshotsTab), QApplication.translate("MainWindow", "Screenshots", None))
        ...
        self.MainTabWidget.setTabText(self.MainTabWidget.indexOf(self.NxcTab), QApplication.translate("MainWindow", "NXC", None))
...
#       self.BottomTabWidget.setTabText(self.BottomTabWidget.indexOf(self.PythonTab), QApplication.translate("MainWindow", "Python", None))
        ...
        self.actionSettings.setShortcut(QApplication.translate("MainWindow", "Ctrl+P", None))
